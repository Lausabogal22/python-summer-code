...
## 🎯 Purpose
The goal of this project is to apply fundamental Python skills in a practical way, using:
- variables
- user input
- basic calculations
- conditional logic
...
This program performs a basic interactive task. It:
- asks the user for input
- processes the information using Python logic
...
## 🎯 Purpose
The goal of this project is to apply Python fundamentals in a practical way, using:
...
## 🛠️ What the Program Does
- This program performs a basic interactive task. 
- creates an Employee object with predefined attributes
- asks the user for the current year
- calculates how many years the employee has worked
- computes the total salary expenses based on years worked
- displays all employee information in a clear format
